!(function (t) {
        ...
        switch (e) {
          case "add":
            t.extend(a, t.validator.normalizeRule(i)),
              (r[s.name] = a),
              i.messages &&
                (n.messages[s.name] = t.extend(n.messages[s.name], i.messages));
            break;
          case "remove":
    ...
    t.extend(t.validator, {
      defaults: {
        ...
        onkeyup: function (t, e) {
          (9 == e.which && "" === this.elementValue(t)) ||
            ((t.name in this.submitted || t === this.lastActive) &&
              this.element(t));
        },
      ...
      prototype: {
        ...
        check: function (e) {
          ...
          for (var a in s) {
            ...
            try {
              if (
                "dependency-mismatch" ===
                (i = t.validator.methods[a].call(this, r, e, u.parameters))
              ) {
                n = !0;
                continue;
              }
        ...
        customMetaMessage: function (e, i) {
          if (t.metadata) {
            var s = this.settings.meta
              ? t(e).metadata()[this.settings.meta]
              : t(e).metadata();
        ...
        showLabel: function (e, i) {
          ...
          s.length
            ? (s
              ...
              s.attr("generated") && s.html("<br />" + i))
            : ((s = t("<" + this.settings.errorElement + "/>")
                .attr({ for: this.idOrName(e), generated: !0 })
                .addClass(this.settings.errorClass)
                .html("<br />" + i || "")),
              this.settings.wrapper &&
                (s = s
      ...
      attributeRules: function (e) {
        ...
        for (var n in t.validator.methods) {
          var r;
          "required" === n
            ? ("" === (r = s.get(0).getAttribute(n)) && (r = !0), (r = !!r))
            : (r = s.attr(n)),
      ...
      methods: {
        ...
        creditcard: function (t, e) {
          ...
          for (
            var i = 0, s = 0, n = !1, r = (t = t.replace(/\D/g, "")).length - 1;
            r >= 0;
            r--
          ) {
            var a = t.charAt(r);
  ...
  (function (t) {
    ...
    if (t.ajaxPrefilter)
      ...
      t.ajax = function (s) {
        ...
        return "abort" === n
          ? (e[r] && e[r].abort(), (e[r] = i.apply(this, arguments)))
  ...
  (function (t) {
    jQuery.event.special.focusin ||
      ...
      t.each({ focus: "focusin", blur: "focusout" }, function (e, i) {
        function s(e) {
